(function (global, factory) {
    ...
    (global = global || self, global.PrismicJS = factory(global.fetch, global.https));
}(this, (function (crossFetch, https) { 'use strict';

    crossFetch = crossFetch && Object.prototype.hasOwnProperty.call(crossFetch, 'default') ? crossFetch['default'] : crossFetch;
    ...
    */
    ...
    var DefaultRequestHandler = /** @class */ (function () {
        function DefaultRequestHandler(options) {
            ...
            this.options = __assign(__assign({}, options), { proxyAgent: options && options.proxyAgent ? options.proxyAgent : httpsAgent });
        }
